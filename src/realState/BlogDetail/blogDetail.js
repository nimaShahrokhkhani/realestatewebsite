...
class blogDetail extends React.Component {
    ...
    render() {
        let {blog} = this.props.location.state ? this.props.location.state : {};
        return (
            <div id='root-div' style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                <div className='blogScreen-container' style={{width: '80%'}}>
                    <h1>{blog.title}</h1>
